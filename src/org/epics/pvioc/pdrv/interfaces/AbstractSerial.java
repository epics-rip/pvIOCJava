...
public abstract class AbstractSerial extends AbstractInterface implements Serial {
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#interruptOccured(byte[], int)
     */
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#write(org.epics.pvioc.pdrv.User, byte[], int)
     */
    public abstract Status write(User user,byte[] data,int nbytes);
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#read(org.epics.pvioc.pdrv.User, byte[], int)
     */
    public abstract Status read(User user,byte[] data,int nbytes);
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#flush(org.epics.pvioc.pdrv.User)
     */
    public abstract Status flush(User user) ;
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#setInputEos(org.epics.pvioc.pdrv.User, byte[], int)
     */
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#getInputEos(org.epics.pvioc.pdrv.User, byte[])
     */
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#setOutputEos(org.epics.pvioc.pdrv.User, byte[], int)
     */
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#getOutputEos(org.epics.pvioc.pdrv.User, byte[])
     */
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#addInterruptUser(org.epics.pvioc.pdrv.User, org.epics.pvioc.pdrv.interfaces.SerialInterruptListener)
     */
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.pdrv.interfaces.Serial#removeInterruptUser(org.epics.pvioc.pdrv.User, org.epics.pvioc.pdrv.interfaces.SerialInterruptListener)
     */
