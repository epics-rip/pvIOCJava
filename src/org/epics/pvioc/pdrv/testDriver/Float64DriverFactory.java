...
import org.epics.pvioc.pdrv.interfaces.AbstractFloat64;


/**
 * The factory for float64Driver.
 * float64Driver is a portDriver for testing the float64 support in org.epics.pvioc.pdrv.support.
    ...
    static private class Float64Driver implements PortDriver {
        ...
        private class Float64Device implements DeviceDriver {   
            ...
            private class Float64Interface extends  AbstractFloat64{
                ...
                /* (non-Javadoc)
                 * @see org.epics.pvioc.pdrv.interfaces.AbstractFloat64#read(org.epics.pvioc.pdrv.User)
                 */
                ...
                /* (non-Javadoc)
                 * @see org.epics.pvioc.pdrv.interfaces.AbstractFloat64#write(org.epics.pvioc.pdrv.User, double)
                 */
