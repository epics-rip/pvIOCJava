...
public class TraceFactory {
    ...
    private static class TraceImpl implements Trace {
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#getTraceFile()
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#getTraceIOMask()
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#getTraceIOTruncateSize()
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#getTraceMask()
         */
        public int getMask() {
            traceLock.lock();
            try {
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#setTraceFile(java.io.Writer)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#setTraceIOMask(int)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#setTraceIOTruncateSize(long)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#setTraceMask(int)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.pdrv.Trace#optionChangeListenerAdd(org.epics.pvioc.pdrv.User, org.epics.pvioc.pdrv.TraceOptionChangeListener)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.pdrv.Trace#optionChangeListenerRemove(org.epics.pvioc.pdrv.User)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.pdrv.Trace#print(int, java.lang.String)
         */
        public void print(int reason, String message) {
            print(reason," %s",message);
        }
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#print(int, java.lang.String, java.lang.Object[])
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.pvioc.pdrv.Trace#printIO(int, byte[], long, java.lang.String)
         */
        public void printIO(int reason, byte[] buffer, long len, String message) {
            printIO(reason,buffer,len,"%s",message);
        }
        /* (non-Javadoc)
         * @see org.epics.pvioc.asyn.Trace#printIO(int, byte[], long, java.lang.String, java.lang.Object[])
         */
