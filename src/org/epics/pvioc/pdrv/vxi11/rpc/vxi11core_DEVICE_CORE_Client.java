 ...
 */
public class vxi11core_DEVICE_CORE_Client extends OncRpcClientStub {

    /**
     * Constructs a <code>vxi11core_DEVICE_CORE_Client</code> client stub proxy object
     ...
     */
    public vxi11core_DEVICE_CORE_Client(InetAddress host, int protocol)
           throws OncRpcException, IOException {
        super(host, vxi11core.DEVICE_CORE, 1, 0, protocol);
    }
     ...
     * @throws IOException if an I/O error occurs.
     */
    public vxi11core_DEVICE_CORE_Client(InetAddress host, int port, int protocol)
           throws OncRpcException, IOException {
        super(host, vxi11core.DEVICE_CORE, 1, port, protocol);
    }
     ...
     * @throws IOException if an I/O error occurs.
     */
    public vxi11core_DEVICE_CORE_Client(OncRpcClient client)
           throws OncRpcException, IOException {
        super(client);
    }
     ...
     * @throws IOException if an I/O error occurs.
     */
    public vxi11core_DEVICE_CORE_Client(InetAddress host, int program, int version, int protocol)
           throws OncRpcException, IOException {
     ...
     * @throws IOException if an I/O error occurs.
     */
    public vxi11core_DEVICE_CORE_Client(InetAddress host, int program, int version, int port, int protocol)
           throws OncRpcException, IOException {
    ...
    public Create_LinkResp create_link_1(Create_LinkParms arg1)
        ...
        client.call(vxi11core.create_link_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_WriteResp device_write_1(Device_WriteParms arg1)
        ...
        client.call(vxi11core.device_write_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_ReadResp device_read_1(Device_ReadParms arg1)
        ...
        client.call(vxi11core.device_read_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_ReadStbResp device_readstb_1(Device_GenericParms arg1)
        ...
        client.call(vxi11core.device_readstb_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error device_trigger_1(Device_GenericParms arg1)
        ...
        client.call(vxi11core.device_trigger_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error device_clear_1(Device_GenericParms arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.device_clear_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error device_remote_1(Device_GenericParms arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.device_remote_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error device_local_1(Device_GenericParms arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.device_local_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error device_lock_1(Device_LockParms arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.device_lock_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error device_unlock_1(Device_Link arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.device_unlock_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error device_enable_srq_1(Device_EnableSrqParms arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.device_enable_srq_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_DocmdResp device_docmd_1(Device_DocmdParms arg1)
        ...
        client.call(vxi11core.device_docmd_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error destroy_link_1(Device_Link arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.destroy_link_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error create_intr_chan_1(Device_RemoteFunc arg1)
           throws OncRpcException, IOException {
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.create_intr_chan_1, vxi11core.DEVICE_CORE_VERSION, arg1, result$);
        return result$;
    }
    ...
    public Device_Error destroy_intr_chan_1()
        ...
        Device_Error result$ = new Device_Error();
        client.call(vxi11core.destroy_intr_chan_1, vxi11core.DEVICE_CORE_VERSION, args$, result$);
        return result$;
    }

}
// End of vxi11core_DEVICE_CORE_Client.java
