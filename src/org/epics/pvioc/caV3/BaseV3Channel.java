...
V3Channel,ConnectionListener
{
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.channelAccess.ChannelFind#cancelChannelFind()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.channelAccess.ChannelFind#getChannelProvider()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#add(org.epics.pvaccess.client.ChannelGet)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#add(org.epics.pvaccess.client.ChannelPut)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#add(org.epics.pvdata.monitor.Monitor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#remove(org.epics.pvaccess.client.ChannelGet)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#remove(org.epics.pvaccess.client.ChannelPut)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#remove(org.epics.pvdata.monitor.Monitor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#getJcaChannel()
     */
    public Channel getJCAChannel() {
        return jcaChannel;
    }
    /* (non-Javadoc)
     * @see org.epics.pvioc.caV3.V3Channel#getExecutor()
     */
