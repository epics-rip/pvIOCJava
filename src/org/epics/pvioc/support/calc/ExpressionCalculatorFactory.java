...
public abstract class ExpressionCalculatorFactory  {
    ...
    private static class ExpressionCalculator extends AbstractSupport {
        ...
        private class Parse {
            ...
            private boolean unwindExpStack(Expression exp,Stack<Expression> expStack) {
                ...
                case booleanConstant: {
                    ...
                    PVBoolean pv = (PVBoolean)pvDataCreate.createPVScalar(ScalarType.pvBoolean);
                    pv.put(scalar);
                    pv.setImmutable();
                    exp.pvResult = pv;
                    expStack.push(exp);
                ...
                case stringConstant: {
                    ...
                    PVString pv = (PVString)pvDataCreate.createPVScalar(ScalarType.pvString);
                    pv.put(scalar);
                    pv.setImmutable();
                    exp.pvResult = pv;
                    expStack.push(exp);
                ...
                case mathConstant: {
                    ...
                    PVDouble pv = (PVDouble)pvDataCreate.createPVScalar(ScalarType.pvDouble);
        ...
        static class UnaryPlus implements Operator {
            ...
            /* (non-Javadoc)
             * @see org.epics.pvioc.support.calc.ExpressionCalculatorFactory.ExpressionCalculator.Operator#createPVResult()
             */
            @Override
            public boolean createPVResult() {
            ...
            /* (non-Javadoc)
             * @see org.epics.pvioc.support.calc.ExpressionCalculatorFactory.ExpressionCalculator.Operator#compute()
             */
            public void compute() {
        ...
        static class UnaryMinus implements Operator {
            ...
            /* (non-Javadoc)
             * @see org.epics.pvioc.support.calc.ExpressionCalculatorFactory.ExpressionCalculator.Operator#createPVResult(java.lang.String)
             */
            @Override
            public boolean createPVResult() {
                ...
                resultPV = pvDataCreate.createPVScalar(resultType);
        ...
        static class BooleanNot implements Operator {
            ...
            public boolean createPVResult() {
                ...
                resultPV = (PVBoolean)pvDataCreate.createPVScalar(ScalarType.pvBoolean);
                operatorExpression.pvResult = resultPV;
                return true;
            }
            /* (non-Javadoc)
        ...
        static class StringPlus implements Operator {
            ...
            public boolean createPVResult() {
                arg0PV = operatorExpression.expressionArguments[0].pvResult;
                arg1PV = operatorExpression.expressionArguments[1].pvResult;
                resultPV = (PVString)pvDataCreate.createPVScalar(ScalarType.pvString);
                operatorExpression.pvResult = resultPV;
                return true;
            }
            /* (non-Javadoc)
        ...
        abstract static class ShiftBase implements Operator {
            ...
            public boolean createPVResult() {
                ...
                resultType = arg0Type;
                resultPV = pvDataCreate.createPVScalar(arg0Type);
                operatorExpression.pvResult = resultPV;
                return true;
            }
            abstract public void compute();
        ...
        static class TernaryIf implements Operator {
            ...
            public boolean createPVResult() {
                ...
                pvResult = pvDataCreate.createPVScalar(resultType);
        ...
        abstract static class MathDoubleOneArg implements Operator {
            ...
            public boolean createPVResult() {
                ...
                pvResult = (PVDouble)pvDataCreate.createPVScalar(ScalarType.pvDouble);
