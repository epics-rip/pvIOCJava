 ...
 * It is called just before locateSupport.process or locateSupport.processContinue returns.
 * </p>
 ...
 * because RecordProcess locks a record instance before calling locateSupport.process.</p>
