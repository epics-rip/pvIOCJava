...
/**
 */
public abstract class vxi11core_DEVICE_CORE_ServerStub extends OncRpcServerStub implements OncRpcDispatchable {

    public vxi11core_DEVICE_CORE_ServerStub()
           throws OncRpcException, IOException {
        this(0);
    }

    public vxi11core_DEVICE_CORE_ServerStub(int port)
           throws OncRpcException, IOException {
        this(null, port);
    }

    public vxi11core_DEVICE_CORE_ServerStub(InetAddress bindAddr, int port)
           throws OncRpcException, IOException {
        info = new OncRpcServerTransportRegistrationInfo [] {
            new OncRpcServerTransportRegistrationInfo(vxi11core.DEVICE_CORE, 1),
        };
...
// End of vxi11core_DEVICE_CORE_ServerStub.java
