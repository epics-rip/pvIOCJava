...
import org.epics.ioc.pvAccess.PVDouble;
import org.epics.ioc.pvAccess.PVEnum;
import org.epics.ioc.pvAccess.PVString;
...
public class ChannelMonitorTest extends TestCase {
    ...
    public static void testChannelData() {
        ...
        XMLToDBDFactory.convert(dbd,
                 ...
                 iocRequestor);
        XMLToDBDFactory.convert(dbd,
                 "src/org/epics/ioc/channelAccess/example/exampleDBD.xml",
                 iocRequestor);        
        boolean initOK = IOCFactory.initDatabase(
            "src/org/epics/ioc/channelAccess/example/exampleDB.xml",iocRequestor);
        if(!initOK) return;
        Monitor monitor;
    ...
    ChannelMonitorRequestor,ChannelStateListener {
        ...
        /* (non-Javadoc)
         * @see org.epics.ioc.channelAccess.ChannelMonitorRequestor#monitorData(java.util.List, java.util.List)
         */
    ...
    ChannelMonitorNotifyRequestor,ChannelStateListener {
        ...
        /* (non-Javadoc)
         * @see org.epics.ioc.channelAccess.ChannelMonitorNotifyRequestor#monitorEvent()
         */
