 ...
 */
package org.epics.ioc.pvCopy.test;
...
public class PVCopyTest extends TestCase {
    ...
    public static void testPVCopy() {
     // get database for testing
        ...
        XMLToPVDatabaseFactory.convert(master,"${JAVAIOC}/src/org/epics/ioc/pvCopy/test/powerSupply.xml", iocRequester);
        XMLToPVDatabaseFactory.convert(master,"${JAVAIOC}/src/org/epics/ioc/pvCopy/test/powerSupplyArray.xml", iocRequester);
        XMLToPVDatabaseFactory.convert(master,"${JAVAIOC}/src/org/epics/ioc/pvCopy/test/structuresForPVCopyTest.xml", iocRequester);
