...
public class LongAlarmFactory {
    ...
    public static Support create(PVStructure pvStructure) {
        return new LongAlarmImpl(pvStructure);
    }
    ...
    private static class LongAlarmImpl extends AbstractSupport
    {
        ...
        private LongAlarmImpl(PVStructure pvStructure) {
            super("longAlarm",pvStructure);
        ...
        public void start(AfterStart afterStart) {
            ...
            for(int i=0; i<size; i++) {
                ...
                PVLong pvValue = pvStructure.getLongField("value");
                if(pvValue==null) return;
