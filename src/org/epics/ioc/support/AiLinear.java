 ...
 *
 */
public class AiLinear implements RecordSupport {
    private static String supportName = "AiLinear";
    private DBRecord dbRecord = null;
    private DBStructure dbStructure = null;
    
    public AiLinear(DBRecord dbRecord) {
        this.dbRecord = dbRecord;
    }
    public AiLinear(DBStructure dbStructure) {
