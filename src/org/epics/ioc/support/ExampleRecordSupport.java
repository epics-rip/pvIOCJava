 ...
 *
 */
public class ExampleRecordSupport implements RecordSupport {
    private static String supportName = "ExampleRecordSupport";
    private DBRecord dbRecord = null;
    private DBStructure dbStructure = null;
    
    public ExampleRecordSupport(DBRecord dbRecord) {
        this.dbRecord = dbRecord;
    }
    public ExampleRecordSupport(DBStructure dbStructure) {
