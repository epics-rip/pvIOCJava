    ...
    
    {
     // following are global to embedded classes
        ...
        ChannelRequester,ConnectChannelRequester,CreateFieldRequestRequester,Runnable,ChannelPutGetRequester
        {
            ...
            /* (non-Javadoc)
             * @see org.epics.ioc.swtshell.CreateFieldRequestRequester#getDefault()
             */
            @Override
            ...
            /* (non-Javadoc)
             * @see org.epics.ca.client.ChannelPutGetRequester#channelPutGetConnect(Status,org.epics.ca.client.ChannelPutGet, org.epics.pvData.pv.PVStructure, org.epics.pvData.misc.BitSet, org.epics.pvData.pv.PVStructure, org.epics.pvData.misc.BitSet)
             */
            @Override
