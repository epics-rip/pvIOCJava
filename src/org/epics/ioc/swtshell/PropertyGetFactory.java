...
/**
 * Factory that implements PropertyGet.
 * @author mrk
 *
 */
public class PropertyGetFactory {
    /**
     * Create the PropertyGet shell.
     * @param parent The parent shell.
     * @return The PropertyGet interface.
     */
    public static PropertyGet create(Shell parent) {
        return new PropertyGetImpl(parent);
    }
    
    private static class PropertyGetImpl extends Dialog implements PropertyGet, SelectionListener {
        private static final String[] noPropertyNames = new String[0];
        ...
        private PropertyGetImpl(Shell parent) {
         ...
         * @return
         */
        public String[] getPropertyNames(ChannelField channelField) {
            propertyNames = channelField.getPropertyNames();
            if(propertyNames==null) return noPropertyNames;
