...
public class MessageQueueFactory {
    ...
    private static class MessageQueueImpl implements MessageQueue {
        ...
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#lock()
         */
        public void lock() {
            lock.lock();
        }
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#unlock()
         */
        public void unlock() {
            lock.unlock();
        }
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#getNext()
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#put(java.lang.String, org.epics.ioc.util.MessageType)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#isEmpty()
         */
        public boolean isEmpty() {
            return ((numFree==size) ? true : false);
        }
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#isFree()
         */
        public boolean isFull() {
            return ((numFree==0) ? true : false);
        }
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#replaceFirst(java.lang.String, org.epics.ioc.util.MessageType)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#replaceLast(java.lang.String, org.epics.ioc.util.MessageType)
         */
        ...
        /* (non-Javadoc)
         * @see org.epics.ioc.util.MessageQueue#getClearOverrun()
         */
