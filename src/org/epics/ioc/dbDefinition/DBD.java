...
/**
 * DBD (DatabaseDefinition) is for locating interfaces for
 * menu, structure, record, and linkSupport definitions.
 * In DBD record describes a record type.
 * @author mrk
 *
 */
public interface DBD {
    /**
     * get the name of this DBD. Multiple DBDs can be created via DBDCreateFactory
     * @return the DBD name.
     */
    String getName();
    /**
