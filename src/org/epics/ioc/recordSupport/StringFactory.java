...
public class StringFactory {
    public static Support create(DBStructure dbStructure) {
        return new StringImpl(dbStructure);
    }
    ...
    static private class StringImpl extends AbstractSupport
    implements SupportProcessRequester
    {
        private static String supportName = "stringRecord";
        ...
        private StringImpl(DBStructure dbStructure) {
