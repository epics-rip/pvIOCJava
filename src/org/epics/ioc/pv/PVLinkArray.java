 ...
 *
 */
public interface PVLinkArray extends PVArray{
    /**
     * Get values from a <i>PVLinkArray</i>
     * and put them into <i>PVLink[]to</i>.
    ...
    /**
     * Put values into a <i>PVLinkArray</i> from <i>PVLink[]to</i>.
