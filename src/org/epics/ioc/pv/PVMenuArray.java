 ...
 *
 */
public interface PVMenuArray extends PVArray{
    /**
     * Get values from a <i>PVMenuArray</i>
     * and put them into <i>PVMenu[]to</i>.
    ...
    /**
     * Put values into a <i>PVMenuArray</i> from <i>PVMenu[]to</i>.
