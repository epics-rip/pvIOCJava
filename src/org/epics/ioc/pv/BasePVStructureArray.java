...
public class BasePVStructureArray extends AbstractPVArray implements PVStructureArray
{
     ...
     */
    public BasePVStructureArray(PVField parent,Array array,
    ...
    public PVField getSubField(String fieldName) {
        for(PVStructure pvStructure : value) {
            if(pvStructure.getField().getFieldName().equals(fieldName)) return pvStructure;
        }
        return null;
    }
    /* (non-Javadoc)
